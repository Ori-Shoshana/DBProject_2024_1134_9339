...
prompt Created by 212or on Tuesday, 4 June 2024
set feedback off
set define off
...
values (1, to_date('24-09-2023', 'dd-mm-yyyy'), 'Dance', 72);
insert into ACTIVITY (activity_id, date_of_activity, activity_name, capacity)
...
values (1, to_date('07-05-2023', 'dd-mm-yyyy'), 'Rebecca Valencia', 'YES');
insert into TRANSPORTATION (transportation_id, departure_time, driver_name, in_time)
...
prompt 400 records committed...
insert into TRIPS (locations, grade, trip_maneger_id, trip_date, trip_topic)
values ('West Danny', '9', 219474001, to_date('03-08-2023', 'dd-mm-yyyy'), 'Sports');
insert into TRIPS (locations, grade, trip_maneger_id, trip_date, trip_topic)
